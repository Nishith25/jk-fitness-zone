...
export default function Login() {
  ...
  const roleIcons = {
    admin: <BadgeCheck size={20} />,
    trainer: <UserRound size={20} />,
    customer: <UserRound size={20} />,
  };
      ...
      <div className="container auth-container">
        <div className="card auth-card login-card">
          <div className="login-top">
            <div className="login-icon-box">{roleIcons[role]}</div>
          ...
          <p className="card-text small-text login-note">
            Customers must use the Customer ID generated by the gym. Admin and
            trainer users must use their registered phone number.
          </p>
        </div>
      </div>
    </section>
